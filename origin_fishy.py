...
class SLEAP_Instance_Class:
    ...
    def __enter__(self):
        ...
        self.axes.set_xlim(100,900)
        self.axes.set_ylim(100,900)
    ...
    def plot_frame(self, frame):
        ...
        self.axes.set_xlim(100, 900)
        self.axes.set_ylim(100, 900)
        self.axes.set_title(f"frame: {frame}")
...
if __name__ == '__main__':
    fishy = SLEAP_Instance_Class('drosophila-melanogaster-courtship\\fly.h5')
    with fishy as f:
        f.plot_frame(0)
        animate = f.animate()
        animate.save('fish_animation.gif', writer='pillow', fps=5)
        plt.show()
